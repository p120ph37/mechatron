export class Color {
  ...
  constructor(obj: { r: number; g: number; b: number; a?: number });
  constructor(a?: number | Color | { r: number; g: number; b: number; a?: number }, g?: number, b?: number, alpha?: number) {
    if (a === undefined) {
      this.a = 0; this.r = 0; this.g = 0; this.b = 0;
    } else if (a instanceof Color) {
      this.a = a.a; this.r = a.r; this.g = a.g; this.b = a.b;
    } else if (typeof a === "object") {
      this.r = a.r; this.g = a.g; this.b = a.b;
      this.a = a.a !== undefined ? a.a : 255;
    } else if (g !== undefined) {
      this.r = a; this.g = g; this.b = b!;
  ...
  setARGB(argb: number): void {
    if (typeof argb !== "number") throw new TypeError("Invalid arguments");
  ...
  clone(): Color { return new Color(this); }

  toString(): string {
    return `[${this.r}, ${this.g}, ${this.b}, ${this.a}]`;
  }

  static normalize(...args: any[]): { r: number; g: number; b: number; a: number } {
    if (args.length === 0) return { r: 0, g: 0, b: 0, a: 0 };
    const c = Color._resolve(args);
    return { r: c.r, g: c.g, b: c.b, a: c.a };
  }

  /** @internal */
  static _resolve(args: any[]): { a: number; r: number; g: number; b: number } {
    const a0 = args[0];
    if (a0 instanceof Color) return { a: a0.a, r: a0.r, g: a0.g, b: a0.b };
