/**
 * nolib window backend — X11 wire protocol implementation.
 *
 * Extracted from window.ts so the portal variant can lazy-load this
 * only when an X11 connection is available.
 */
