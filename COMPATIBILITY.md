...
| Function | linux-napi[x11] | linux-napi[portal] | linux-nolib[x11] | linux-nolib[portal] | linux-nolib[gext] | linux-nolib[vt] | win32-napi | win32-ffi | darwin-napi | darwin-ffi |
|----------|------|------|------|------|------|------|------|------|------|------|
...
| keyboard_getKeyState | ok | skip | ok | skip | ok | skip | ok | ok | ok | ok |
...
| mouse_getPos | ok | skip | ok | skip | ok | skip | ok | ok | ok | ok |
| mouse_setPos | ok | ok | ok | ok | ok | ok | ok | ok | ok | ok |
| mouse_getButtonState | ok | skip | ok | skip | ok | skip | ok | ok | ok | ok |

## Window

| Function | linux-napi[x11] | linux-nolib[x11] | linux-nolib[portal] | linux-nolib[gext] | win32-napi | win32-ffi | darwin-napi | darwin-ffi |
|----------|------|------|------|------|------|------|------|------|
| window_ctor | ok | ok | ok | ok | ok | ok | ok | ok |
| window_isValid | ok | ok | ok | ok | ok | ok | ok | ok |
| window_close | ok | ok | skip | ok | ok | ok | ok | ok |
| window_isTopMost | ok | ok | skip | ok | ok | ok | ok | ok |
| window_isBorderless | ok | ok | skip | skip | ok | ok | skip | skip |
| window_isMinimized | ok | ok | skip | ok | ok | ok | ok | ok |
| window_isMaximized | ok | ok | skip | ok | ok | ok | ok | ok |
| window_setTopMost | ok | ok | skip | ok | ok | ok | skip | skip |
| window_setBorderless | ok | ok | skip | skip | ok | ok | skip | skip |
| window_setMinimized | ok | ok | skip | ok | ok | ok | ok | ok |
| window_setMaximized | ok | ok | skip | ok | ok | ok | ok | ok |
| window_getProcess | ok | ok | skip | ok | ok | ok | ok | ok |
| window_getPID | ok | ok | skip | ok | ok | ok | ok | ok |
...
| window_setClient | ok | ok | skip | ok | ok | ok | ok | ok |
| window_mapToClient | ok | ok | ok | ok | ok | ok | ok | ok |
| window_mapToScreen | ok | ok | ok | ok | ok | ok | ok | ok |
| window_getList | ok | ok | ok | ok | ok | ok | ok | ok |
| window_getActive | ok | ok | skip | ok | ok | ok | ok | ok |
| window_setActive | ok | ok | skip | ok | ok | ok | ok | ok |
| window_isAxEnabled | ok | ok | ok | ok | ok | ok | ok | ok |
| window_isValid_proc | skip | ok | skip | skip | skip | skip | skip | skip |
...
| Function | linux-napi[x11] | linux-napi[portal] | linux-nolib[x11] | linux-nolib[portal] | linux-nolib[vt] | win32-napi | win32-ffi | darwin-napi | darwin-ffi |
|----------|------|------|------|------|------|------|------|------|------|
...
| screen_getPortalToken | skip | ok | skip | ok | skip | skip | skip | skip | skip |
| screen_setPortalToken | skip | ok | skip | ok | skip | skip | skip | skip | skip |

## Clipboard

| Function | linux-napi[x11] | linux-napi[portal] | linux-nolib[x11] | linux-nolib[sh] | win32-napi | win32-ffi | darwin-napi | darwin-ffi | darwin-nolib[sh] |
|----------|------|------|------|------|------|------|------|------|------|
