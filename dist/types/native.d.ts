export interface NativeBackend {
    ...
    process_getModules(pid: number, regex?: string): Array<{
        valid: boolean;
        name: string;
        path: string;
        base: number;
    ...
    process_getSegments(pid: number, base: number): Array<{
        valid: boolean;
        base: number;
        size: number;
        name: string;
    ...
    memory_getRegions(pid: number, start?: number, stop?: number): Array<{
        valid: boolean;
        bound: boolean;
        start: number;
        stop: number;
...
export declare function getNativeBackend(): NativeBackend;
export declare function setNativeBackend(backend: NativeBackend): void;
