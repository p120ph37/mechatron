# @mechatronic/ffi-keyboard

Native FFI shared library for the mechatron keyboard subsystem.
...
For Node.js / NAPI consumers see [`@mechatronic/napi-keyboard`](https://www.npmjs.com/package/@mechatronic/napi-keyboard).
