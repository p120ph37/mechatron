# @mechatronic/ffi-process

Native FFI shared library for the mechatron process subsystem.
...
For Node.js / NAPI consumers see [`@mechatronic/napi-process`](https://www.npmjs.com/package/@mechatronic/napi-process).
