# @mechatronic/ffi-screen

Native FFI shared library for the mechatron screen subsystem.
...
For Node.js / NAPI consumers see [`@mechatronic/napi-screen`](https://www.npmjs.com/package/@mechatronic/napi-screen).
